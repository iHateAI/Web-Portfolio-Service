...
![logo](./readmeImages/SYP%20LOGO%203.png)
...
- 기간 : 2022.08.22 ~ 2022.09.02
- 주제 : 포트폴리오 공유를 위한 웹사이트 개발 프로젝트
- 목표 : 사용자들 간의 편리한 포트폴리오 공유
- [api 문서](https://ihateai.github.io/Team10_apidoc/)
- [테스트 페이지](http://kdt-ai5-team10.elicecoding.com/)
...
- 북마크 페이지에서 북마크로 지정했던 유저 카드를 모아 볼 수 있습니다.
<details>
<summary>자세히 보기</summary>
...
1. 몽고디비 설치
2. MONGODB_URL 변수에 mongodb://localhost:27017/ 삽입
```

4. 프론트 엔드 서버와 백엔드 서버를 실행합니다.
```
-- npm 사용 시 --
